...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios
      .get(`https://radiant-depths-97196.herokuapp.com/users/${user}`, {
  ...
  validate() {
    ...
    if (!this.state.username) {
      ...
      this.setErr('usernameErr', 'Username must be more than 5 characters');
      isReq = false;
    } else {
  ...
  handleSubmit = (e) => {
    ...
    if (isReq) {
      axios
        .put(
          `https://radiant-depths-97196.herokuapp.com/users/${userName}`,
          {
